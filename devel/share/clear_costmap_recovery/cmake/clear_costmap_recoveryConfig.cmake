...
if("TRUE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/duzhong/dzacs/src/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /home/duzhong/dzacs/devel)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /home/duzhong/dzacs/install)
...
if(NOT "/home/duzhong/dzacs/src/clear_costmap_recovery/include " STREQUAL " ")
  set(clear_costmap_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/duzhong/dzacs/src/clear_costmap_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/clear_costmap_recovery " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'example <example@example.com>, example <example@example.com>, example <example@example.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/duzhong/dzacs/src/clear_costmap_recovery/${idir}'.  ${_report}")
    endif()
...
set(depends "costmap_2d;nav_core;pluginlib;roscpp;tf2_ros;geometry_msgs;std_srvs")
