...
struct ProjectedMapsInfoRequest_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::map_msgs::ProjectedMapInfo_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::map_msgs::ProjectedMapInfo_<ContainerAllocator> >> _projected_maps_info_type;
